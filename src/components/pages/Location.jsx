...
function Location() {
    ...
    return(
        <div>
            <h1 className={`${context.active ? 'mt-52' : 'mt-32'} grid md:mt-28 mb-6 justify-items-center text-center text-2xl font-bold`}>Location <strong className="text-blue-600">{info.name}</strong> </h1>
